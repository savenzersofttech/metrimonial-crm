    ...
    <tbody>
        @forelse($services as $index => $service)
            <tr>
                ...
                <td>
                    @if ($daysLeft > 30)
                        <span class="badge bg-success">{{ round($daysLeft) }} days</span>
                    @elseif ($daysLeft > 0)
                        <span class="badge bg-warning text-dark">{{ round($daysLeft) }} days</span>
                    @else
        ...
        @empty
            <tr>
                <td colspan="11" class="text-center text-muted">No service history found for this profile.</td>
            </tr>
        @endforelse
    </tbody>
</table>
